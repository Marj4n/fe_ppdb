    ...
    >
      ...
      >
        ...
        <Text display="flex" alignSelf="center" mx="auto">
          ...
          /
          <Tooltip label="Laravel">
            <ChakraLink href="https://laravel.com/" display="flex">
              <Icon
                color={useColorModeValue(`gray.800`, `white`)}
                viewBox="0 0 600 580"
                my="auto"
                ...
                alignSelf="center"
              >
                <rect width="600" height="600" rx="100%" fill="currentColor" />
                <path
        ...
        <Stack
          ...
          mr={{ base: `auto`, md: 5 }}
        >
          <SocialIcons label="GitHub" href="https://github.com/Marjan02">
            <FaGithub />
          </SocialIcons>
          <SocialIcons
            label="LinkedIn"
            href="https://www.linkedin.com/in/kevin-yardan-fauzan-73baaa21b/"
          >
            <FaLinkedin />
          </SocialIcons>

          <SocialIcons label="Email" href="mailto:nivkaiser@gmail.com">
            <HiOutlineMail />
          </SocialIcons>
        </Stack>
      </SimpleGrid>
